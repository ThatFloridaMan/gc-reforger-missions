...
{
	[Attribute(desc: "Maximum number of placement for this tool")]
	...
	override void ACE_Trenches_RequestPlace() 
	{
		...
		if ((!m_iACE_Trenches_MaxPrefabCount) && (m_iACE_Trenches_CurrentPrefabCount >= m_iACE_Trenches_MaxPrefabCount))
			return;
